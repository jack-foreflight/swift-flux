...
//@MainActor
//@Observable
//public final class StateModel: SharedState {
//
...
//
//@Observable
//public final class TestStateModel {
//    public var count: Int = 0
//}
//
//@MainActor
//struct TestView: View {
//    let model: TestStateModel
//    @State private var count: Int = 0
//
//    init(model: TestStateModel) {
//        self.model = model
//    }
//
//    var body: some View {
//        let _ = count
//        return withFluxObservationTracking {
//            Button {
//                model.count += 1
//            } label: {
//                Text("\(model.count)")
...
//
////extension Store: @retroactive Singleton {
////    public static nonisolated func inject(container: Container) -> FluxArchitecture.Store {
//
////    }
////}
//
////public final class CounterStore: Store {
////    public override nonisolated class var defaultValue: Store {
////        Store.configure()
////            .withState(
////                StateModel(id: "1")
////            )
...
//
//extension Store {
//    public nonisolated static var defaultValue: Store {
//        print("Override")
//        fatalError()
//    }
//}
